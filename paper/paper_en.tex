...
We thank the maintainers of \texttt{unsloth}, \texttt{transformers}, \texttt{peft}, \texttt{llama.cpp}, and Ollama for the open-source tooling on which this work depends; the authors of CyberMetric and the NYU CTF Bench for releasing reproducible benchmarks; the contributors of the CTFtime writeups that constitute the training corpus; and Cisco's fdtn-ai team for releasing Foundation-Sec-8B as a public reference.
